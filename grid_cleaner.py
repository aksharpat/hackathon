...
def detect_grid(breadboard_image, main_func=False):
    ...
    # TODO: Allow medium/large selections. Small is all we had for now.
...
if __name__ == "__main__":
    ...
    detect_grid(breadboard_image, main_func=True)
