...
print(findShortestPath(graph2, 'POW', 'GND'))
print(isPath(graph2, 'POW', 'GND'))
print(isPath(graph2, 'GND', 'POW'))
print(findAllPaths(graph2, 'POW', 'GND'))
generateDiagram(graph2, "3.3V")